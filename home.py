...
st.title("Welcome to Brand-senti")
...
if company_name!="" and company_name!=" ":
    ...
    reviews,insta_id,pos,neg,social_media_links=sentiment_analyse(company_name)
    try:
    ...
    #prev_values=db.child(company_name).get()
        ...
        if fetch_dict[7]>number_of_twitter_followers:
            base_value-=0.01
    ...
    data={"pos_value":pos,'neg_value':neg,"insta_followers":count["Followers"],"new_base":base_value,"insta_id":insta_id,"linkedin_followers":total_followers_linkedin,"linkedin_reaction_count":total_count_reaction,"twitter_followers":number_of_twitter_followers,"under_reviews":reviews,"zlinks":social_media_links}
